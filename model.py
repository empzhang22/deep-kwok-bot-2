...
async def generate_text(message, context):
    print("generating...")
    ...
    single_text = gpt2.generate(sess, length=250, temperature=0.7, nsamples=1, batch_size=1, return_as_list=True, prefix=context)[0]
